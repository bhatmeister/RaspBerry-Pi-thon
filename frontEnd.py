...
class News(Page):
    def __init__(self, *args, **kwargs):
        ...
        T1 = tk.Label(self, height=6, width=80)
        T1.place(x=0, y=25)
        T2 = tk.Label(self, height=6, width=80)
        T2.place(x=0, y=160)
        T3 = tk.Label(self, height=6, width=80)
        T3.place(x=0, y=280)
